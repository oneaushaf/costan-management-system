...
<html lang="en" data-bs-theme="auto">
  <head><script src="../../assets/js/color-modes.js"></script>
    ...
    <title>Admin | {{Auth::guard('admin')->user()->name}}</title>
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="/admin/index">Costan</a>
  <button class="navbar-toggler position-absolute d-md-none collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarMenu" aria-controls="sidebarMenu" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
  <div class="form-control form-control-dark w-100 rounded-0 border-0"></div>
  <div class="navbar-nav">
    <form class="nav-item text-nowrap" action="/admin/logout" method="post">
      @csrf
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-body-tertiary sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link {{Request::is('admin/roomtypes*')?"active":""}}" href="/admin/roomtypes">
          ...
          <li class="nav-item">
            <a class="nav-link {{Request::is('admin/request*')?"active":""}}" href="/admin/requests">
